...
because your projects are for vastly different projects. In this case, you can
create a new file `README-yourplatform` and create the perfect boilerplate for
that.
